...
Character::Character(int healthPoints, int defensePoints, int attackPoints, Race race):Entity(),healthPoints(healthPoints), defensePoints(defensePoints),attackPoints(attackPoints),race(race){}
